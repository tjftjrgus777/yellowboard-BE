...
import com.bitcamp.board_back.feature.user.service.implement.AccountUserDetailServiceImplement;
...
public class JwtProvider {
    ...
    private final AccountUserDetailServiceImplement accountUserDetailServiceImplement;
    ...
    public Authentication createAuthentication(String email) {
        UserDetails userDetails = accountUserDetailServiceImplement.loadUserByUsername(email);
